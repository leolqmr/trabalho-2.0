...
export const metadata: Metadata = {
  title: 'CInCoders ReactJS StarterKit - Documentação',
  description:
    'Documentação completa do CInCoders ReactJS StarterKit com Vite, Keycloak e o design system da CInCoders. Setup, arquitetura, guias de desenvolvimento.',
};
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="relative mb-16 overflow-hidden pt-6 text-center">
        <h1 className="mb-4 font-bold text-4xl tracking-tight">CInCoders ReactJS StarterKit</h1>
        <p className="mx-auto mb-8 max-w-2xl text-fd-muted-foreground text-lg">
          Uma base estruturada e modular para criar aplicações frontend em React com TypeScript,
          já integrada ao Keycloak e ao padrão de módulos usado nos projetos CIn.
        </p>
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <a
            href="https://gitlab.cin.ufpe.br/cincoders/platform/cincoders-reactjs-boilerplate"
      ...
      <div className="mb-16 grid gap-4 md:grid-cols-3">
        <FeatureCard
          ...
          description="Gere um novo projeto a partir do boilerplate e rode o ambiente de desenvolvimento."
        />
        ...
        <FeatureCard
          ...
          title="Arquitetura"
          description="Entenda a estrutura de pastas, autenticação, estado e tratamento de erros."
        />
        ...
        <FeatureCard
          ...
          description="Crie novos módulos de domínio seguindo o padrão do boilerplate."
        />
      </div>
        ...
        <div className="rounded-xl border bg-fd-card/50 p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <QuickLink
              href="/docs/architecture/authentication"
              title="Autenticação"
              description="OIDC + Keycloak"
            />
            <QuickLink
              href="/docs/architecture/state-management"
              title="Estado"
              description="useAsync, RHF + Zod"
            />
            <QuickLink
              href="/docs/architecture/overview"
              title="Estrutura"
              description="Rotas, módulos, layout"
            />
            <QuickLink
              href="/docs/architecture/error-handling"
              title="Erros"
              description="ErrorBoundary e toasts"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mb-16 grid gap-4 md:grid-cols-2">
        ...
        >
          ...
          <div>
            ...
            <p className="text-fd-muted-foreground text-sm">
              React 18, Vite, react-router-dom, Keycloak, Tailwind CSS, Vitest
            </p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            <h3 className="mb-1 font-semibold">Módulos de Exemplo</h3>
            <p className="text-fd-muted-foreground text-sm">
              todos e team — os gabaritos que acompanham o boilerplate
            </p>
          </div>
        </Link>
      </div>
      ...
      <div className="relative overflow-hidden rounded-xl border bg-fd-card/50 px-8 py-18 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="mb-6 text-fd-muted-foreground text-sm">
            O CInCoders ReactJS StarterKit é mantido pelo CInCoders. Contribuições são bem-vindas!
          </p>
          <ul
